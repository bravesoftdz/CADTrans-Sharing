...
uses Gost, DebugNarrowFormUnit, Belts.MultiGroove, Belts.Narrow, Belts.Vee, Belts.Film, Belts.Flat;
...
begin
  Gears := TList.Create;
  Gears.Add(TMultiGrooveBelt.Create);
  Gears.Add(TNarrowVeeBelt.Create);
  Gears.Add(TVeeBelt.Create);
  Gears.Add(TFilmBelt.Create);
